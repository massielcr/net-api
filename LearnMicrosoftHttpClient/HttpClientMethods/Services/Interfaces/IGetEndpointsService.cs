...
namespace HttpClientMethods.Services
{
    public interface IGetEndpointsService
    {
        ...
        IAsyncEnumerable<(string commitMessage, DateTime commitDate)> GetRepositoryCommitsStreamAsync(string orgName, string repositoryName, int page, int perPage, int totalPages, CancellationToken cancellationToken);
    }
}
